...
var storagepoolsResource = schema.GroupVersionResource{Group: "scp.openebs.io", Version: "v1alpha1", Resource: "storagepools"}

var storagepoolsKind = schema.GroupVersionKind{Group: "scp.openebs.io", Version: "v1alpha1", Kind: "StoragePool"}
...
func (c *FakeStoragePools) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.StoragePool, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(storagepoolsResource, c.ns, name, pt, data, subresources...), &v1alpha1.StoragePool{})
