...
import (
	...
	scp "github.com/openebs/device-localpv/pkg/generated/informer/scp/externalversions/scp"
...
func (f *sharedInformerFactory) Scp() scp.Interface {
	return scp.New(f, f.namespace, f.tweakListOptions)
}
