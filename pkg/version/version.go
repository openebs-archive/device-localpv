...
const (
	versionFile   string = "/src/github.com/openebs/device-localpv/VERSION"
	buildMetaFile string = "/src/github.com/openebs/device-localpv/BUILDMETA"
)
...
func GetVersionDetails() string {
	return "device-" + strings.Join([]string{Get(), GetGitCommit()[0:7]}, "-")
}
