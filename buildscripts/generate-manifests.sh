...
# Do the modification in the code and run the `make manifests` command
# to generate the CRD definition' > deploy/yamls/storagepool-crd.yaml
...
# Do the modification in the code and run the `make manifests` command
# to generate the CRD definition' > deploy/yamls/storagevolume-crd.yaml


cat deploy/yamls/scp.openebs.io_storagevolumes.yaml >> deploy/yamls/storagevolume-crd.yaml
rm deploy/yamls/scp.openebs.io_storagevolumes.yaml
