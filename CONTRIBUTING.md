...
Device-LocalPV is an Apache 2.0 Licensed project and all your commits should be signed with Developer Certificate of Origin. See [Sign your work](#sign-your-work).

* Find an issue to work on or create a new issue. The issues are maintained at [device-localpv/issues](https://github.com/openebs/device-localpv/issues). You can pick up from a list of [good-first-issues](https://github.com/openebs/device-localpv/labels/good%20first%20issue).
